        ...
        <div className="flex justify-between items-center py-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-blue-100 text-sm">Campus Placement Management</p>
            </div>
          </div>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            {authStatus !== 'authenticated' && (
              <>
                <Link to="/dashboard" className="hover:text-blue-200 transition-colors">Create Account</Link>
                <Link to="/dashboard" className="hover:text-blue-200 transition-colors">Login</Link>
              </>
            )}
